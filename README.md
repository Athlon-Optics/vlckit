...
The immutable `4.0.0a21-sp.1-rc.2` release candidate contains the iOS device
...
pod 'SwingPulseVLCKit',
    :podspec => 'https://raw.githubusercontent.com/Athlon-Optics/vlckit/4.0.0a21-sp.1-rc.2/SwingPulseVLCKit.podspec'
```
